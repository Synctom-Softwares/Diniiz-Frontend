                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                ...
                                <div className='flex w-full items-center'>
                                    <label className="w-2/6 text-left text-sm text-textSecondary font-medium">Select Type</label>
                                ...
                                <div>
                                    <p className='font-semibold text-sm'> <span className='text-red-500 text-[16px]'>* </span>This action is permanent, Deleting / Suspending will delete all associate data. It also block all other users and plan bill.</p>
                                </div>
