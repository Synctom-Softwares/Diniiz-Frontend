...
return (
  <div className="mx-auto h-[95vh] mt-5 w-full max-w-md p-[2rem] 
    ...
    <div className="md:mt-10">
      ...
      <div className="flex justify-start mt-2">
        <p className="font-inter text-[#515151] text-[12px] md:text-[14px]">Don't have an account? <span className="text-primary">Sign Up</span></p>
