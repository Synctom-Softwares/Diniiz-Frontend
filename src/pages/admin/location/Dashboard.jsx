...
import LocationAdminMetrics from '@/components/location/dashboard/LocationAdminMatrics';
...
import RevenueChart from '@/components/location/dashboard/RevenueChart';
  ...
  return (
    <DashboardLayout title={"Dashboard"}>
      <div className="grid grid-cols-12 xl:grid-cols-13 m-4 gap-4 *:rounded-3xl">
        ...
        <div className="flex items-center justify-center col-span-6 xl:col-span-4 bg-white border">
          <ReservationChart />
        </div>
      </div>
    </DashboardLayout>
