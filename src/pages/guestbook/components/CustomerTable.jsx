...
import { FileText, AlertTriangle, Worm } from "lucide-react";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
export function CustomerTable({ customers, onCustomerSelect, restartPagination = false }) {
    ...
    <div className="bg-white rounded-lg">
        ...
        <TableBody>
          {currentCustomers.map((customer) => (
            ...
            >
              ...
              <TableCell>{formatDate(customer.lastVisited)}</TableCell>
              <TableCell>
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        ...
                        >
                          <img src="/virus.svg" alt="allergies"/>
                        </Button>
                      </TooltipTrigger>
                      <TooltipContent>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 py-4 border-t">
        <div className="text-sm text-muted-foreground w-full text-center sm:text-left">
          Showing data {startIndex + 1} to {startIndex + currentCustomers.length} of {customers.length}{" "}
          entries
        </div>
